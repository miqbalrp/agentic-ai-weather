...
translator_agent = Agent(
    ...
    instructions="You translate the input into English, Chinese, and Arabic."
)

async def run_agent(user_input: str):
    first_result = await Runner.run(weather_specialist_agent, user_input)
    second_result = await Runner.run(translator_agent, first_result.final_output)
